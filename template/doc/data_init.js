...
var a= {code:'providerManagement',name:'供应商开通',cat:'供应商',isEnable:true,createTime:1394671086295,updateTime:1394671086295,operatorID:ObjectId('5320ff9b6532aa00951ff5e0'),order:1}
db.PRO.MODULE.save(a);

var a={code:'providerMemberManagement',name:'供应商账号开通',cat:'供应商',isEnable:true,createTime:1394671086295,updateTime:1394671086295,operatorID:ObjectId('5320ff9b6532aa00951ff5e0'),order:2}
db.PRO.MODULE.save(a);

var a={code:'ticketManagement',name:'门票产品录入',cat:'产品管理',isEnable:true,createTime:1394671086295,updateTime:1394671086295,operatorID:ObjectId('5320ff9b6532aa00951ff5e0'),order:10}
db.PRO.MODULE.save(a);
var a={code:'packageManagement',name:'打包产品录入',cat:'产品管理',isEnable:true,createTime:1394671086295,updateTime:1394671086295,operatorID:ObjectId('5320ff9b6532aa00951ff5e0'),order:11}
db.PRO.MODULE.save(a);


var a={code:'hotelPriceInput',name:'酒店价格录入',cat:'价格管理',isEnable:true,createTime:1394671086295,updateTime:1394671086295,operatorID:ObjectId('5320ff9b6532aa00951ff5e0'),order:20}
db.PRO.MODULE.save(a);
var a={code:'voturePriceInput',name:'优惠券价格录入',cat:'价格管理',isEnable:true,createTime:1394671086295,updateTime:1394671086295,operatorID:ObjectId('5320ff9b6532aa00951ff5e0'),order:21}
db.PRO.MODULE.save(a);
var a={code:'ticketPriceInput',name:'门票价格录入',cat:'价格管理',isEnable:true,createTime:1394671086295,updateTime:1394671086295,operatorID:ObjectId('5320ff9b6532aa00951ff5e0'),order:22}
db.PRO.MODULE.save(a);
var a={code:'ticketPriceInput',name:'套票价格录入',cat:'价格管理',isEnable:true,createTime:1394671086295,updateTime:1394671086295,operatorID:ObjectId('5320ff9b6532aa00951ff5e0'),order:23}
db.PRO.MODULE.save(a);
